"""
Django settings for detectServer project.
...
MIDDLEWARE = [
    ...
    'detect.corsmiddleware.corsmiddleware.CORSMiddleware',
]

ROOT_URLCONF = 'detectServer.urls'
